...
P3 (2026-09-04 추가): 12시간(회차 3~4회, 저장 이어하기) 진행. 설문 11·12번(위임·재접속 의사), `go_no_go_template.md` P3 표. 배치 패널에 채집·낚시·판매 위임 자리(23·27·36일 해금)가 생기며 마을 상점가·달무리 늪·문서고 외곽·하숙생 10명이 한 해 동안 열린다.
