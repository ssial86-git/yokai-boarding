...
| `assets/fonts/galmuri11.ttf` | 한글 픽셀 폰트 (11px) | github.com/quiple/galmuri v2.40.4, Lee Minseo | SIL OFL 1.1 (`assets/fonts/galmuri_license.txt`) | 2026-09-02 | 아니오 | UI 기본 폰트. 안티앨리어싱 없이 정수 배율로 표시 |
